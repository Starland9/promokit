...
get sora "Sora%5Bwght%5D.ttf" "$d"; get dmsans "DMSans%5Bopsz%2Cwght%5D.ttf" "$d"; get inter "Inter%5Bopsz%2Cwght%5D.ttf" "$d"; get jetbrainsmono "JetBrainsMono%5Bwght%5D.ttf" "$d"
